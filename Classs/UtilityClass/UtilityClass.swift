...
//        next.delegateOfAlertView = vc as! alertViewMethodsDelegates
    ...
    class func setCustomAlert(title: String, message: String, showStack: Bool = true, showContact:  Bool = true, completionHandler: alertCompletionBlockAJ) -> Void {
        ...
        AJAlertController.initialization().showAlertWithOkButton(aStrTitle: appName, aStrMessage: message, showStack: showStack, showContact: showContact) { (index,title) in
